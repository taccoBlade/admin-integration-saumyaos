          ...
          <RevealItem key={project.id}>
            <Link href={`/projects/${project.id}`} className="block group h-full">
              <motion.div
                ...
                initial="rest"
                whileHover="hover"
                className="relative flex flex-col h-full p-6 rounded-2xl bg-white/[0.03] border border-white/[0.08] group-hover:border-cyan-500/30 group-hover:bg-white/[0.05] transition-colors overflow-hidden cursor-pointer"
              >
