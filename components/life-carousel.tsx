...
export const CARDS = [
  {
    ...
    gradient: "from-attention-900/80 to-slate-950",
    accent: "bg-attention-600",
    dossier: {
...
function CardBackground({ title }: { title: string }) {
  if (title === "Music") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-400 fill-none pointer-events-none transition-all duration-500">
        <defs>
          <pattern id="grid-pattern" width="40" height="40" patternUnits="userSpaceOnUse">
            <path d="M 40 0 L 0 0 0 40" strokeWidth="0.5" stroke="rgba(212, 175, 55, 0.12)" />
          </pattern>
          <filter id="cyan-glow">
        ...
        {/* HUD circles */}
        <circle cx="192" cy="320" r="80" strokeWidth="0.5" stroke="rgba(212, 175, 55, 0.15)" strokeDasharray="3 3" />
        <circle cx="192" cy="320" r="120" strokeWidth="0.5" stroke="rgba(212, 175, 55, 0.08)" />

        {/* Labels */}
        <text x="192" y="460" className="fill-attention-400/70 font-mono text-[9px] tracking-widest" textAnchor="middle">SOUNDSCAPE: AMBIENT</text>
        <text x="192" y="475" className="fill-slate-500 font-mono text-[7px] tracking-wider" textAnchor="middle">FOCUS COEFFICIENT: MAX</text>
        
        <line x1="20" y1="50" x2="20" y2="590" strokeWidth="0.5" stroke="rgba(212, 175, 55, 0.2)" />
      </svg>
    );
  }
  ...
  if (title === "Markets & Investing") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-400 fill-none pointer-events-none transition-all duration-500">
        ...
        <text x="344" y="116" className="fill-attention-400/50 font-mono text-[6px]" textAnchor="end">FIB 100.0% (5240.50)</text>

        <line x1="40" y1="180" x2="344" y2="180" strokeWidth="0.7" strokeDasharray="4 4" stroke="rgba(52, 211, 153, 0.2)" />
        <text x="344" y="176" className="fill-attention-400/40 font-mono text-[6px]" textAnchor="end">FIB 61.8% (5182.20)</text>

        <line x1="40" y1="240" x2="344" y2="240" strokeWidth="0.7" strokeDasharray="4 4" stroke="rgba(52, 211, 153, 0.2)" />
        <text x="344" y="236" className="fill-attention-400/40 font-mono text-[6px]" textAnchor="end">FIB 50.0% (5148.00)</text>

        <line x1="40" y1="300" x2="344" y2="300" strokeWidth="0.7" strokeDasharray="4 4" stroke="rgba(52, 211, 153, 0.2)" />
        <text x="344" y="296" className="fill-attention-400/40 font-mono text-[6px]" textAnchor="end">FIB 38.2% (5113.80)</text>

        <line x1="40" y1="430" x2="344" y2="430" strokeWidth="0.7" strokeDasharray="4 4" stroke="rgba(52, 211, 153, 0.3)" />
        <text x="344" y="426" className="fill-attention-400/50 font-mono text-[6px]" textAnchor="end">FIB 0.0% (5024.10)</text>

        {/* Candlesticks */}
        <line x1="80" y1="360" x2="80" y2="420" strokeWidth="1" stroke="rgba(52, 211, 153, 0.4)" />
        <rect x="73" y="375" width="14" height="30" className="fill-attention-950/60" strokeWidth="1" />
        
        <line x1="140" y1="300" x2="140" y2="380" strokeWidth="1" stroke="rgba(52, 211, 153, 0.4)" />
        <rect x="133" y="315" width="14" height="40" className="fill-attention-950/60" strokeWidth="1" />
        
        <line x1="200" y1="220" x2="200" y2="300" strokeWidth="1" stroke="rgba(52, 211, 153, 0.4)" />
        <rect x="193" y="235" width="14" height="45" className="fill-attention-950/60" strokeWidth="1" />

        <line x1="260" y1="170" x2="260" y2="250" strokeWidth="1" stroke="rgba(52, 211, 153, 0.4)" />
        <rect x="253" y="185" width="14" height="40" className="fill-attention-950/60" strokeWidth="1" />

        {/* Buy limit marker box */}
        <g className="opacity-70">
          <rect x="40" y="335" width="80" height="15" rx="3" className="fill-attention-500/10 stroke-attention-500/30" />
          <text x="80" y="345" className="fill-attention-400 font-mono text-[6px] font-bold" textAnchor="middle">BUY LIMIT @ 5120.0</text>
          <line x1="120" y1="342" x2="260" y2="342" strokeWidth="0.5" strokeDasharray="2 1" />
        </g>

        {/* Dashboard parameters */}
        <text x="45" y="55" className="fill-attention-450/70 font-mono text-[9px] tracking-wider">$SPX: 5240.50 (+1.24%)</text>
        <text x="45" y="70" className="fill-slate-500 font-mono text-[7px]">VOL: 42.58M  |  MA(50): 5104.2</text>

        {/* Volume Bars at Bottom */}
        <g className="opacity-40 fill-attention-500/20">
        ...
        <text x="192" y="540" className="fill-attention-400/40 font-mono text-[7px] tracking-widest" textAnchor="middle">MACD HISTOGRAM OSCILLATOR</text>
      </svg>
    );
  }
  ...
  if (title === "Photography") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-500 fill-none pointer-events-none transition-all duration-500">
        <defs>
          <filter id="rose-glow">
            <feGaussianBlur stdDeviation="3" result="coloredBlur"/>
            <feMerge>
        ...
        <circle cx="192" cy="300" r="4" className="fill-attention-500" stroke="none" />
        ...
        <text x="280" y="295" className="fill-attention-500/60 font-mono text-[6px]">FOCUS: PEAKING 94%</text>
        ...
        <text x="45" y="500" className="fill-attention-500/70 font-mono text-[9px] tracking-wider">F/2.8  |  ISO 800  |  1/60s</text>
        <text x="45" y="515" className="fill-slate-500 font-mono text-[7px]">4K ProRes 422 HQ  |  60 FPS</text>

        {/* Audio VU meter */}
        <g className="fill-attention-500/25">
          ...
          <rect x="330" y="272" width="8" height="4" className="fill-attention-500" />
          <rect x="330" y="280" width="8" height="4" className="fill-attention-500" />
          <rect x="330" y="288" width="8" height="4" className="fill-attention-500" />
        </g>
        <text x="334" y="230" className="fill-attention-500/60 font-mono text-[6px] rotate-90 origin-left">CH1 VU</text>

        {/* Video Audio Waveform timeline at bottom */}
        <g className="opacity-30">
          <text x="45" y="405" className="fill-attention-500/50 font-mono text-[6px]">A1_DIALOGUE.wav</text>
          <path d="M 45 420 L 60 420 L 65 410 L 70 430 L 75 420 L 100 420 L 105 405 L 110 435 L 115 420 L 140 420" strokeWidth="0.8" />
          <text x="175" y="405" className="fill-attention-500/50 font-mono text-[6px]">A2_SFX.wav</text>
        ...
        <g>
          <circle cx="330" cy="50" r="5" className="fill-attention-600 stroke-none" />
          <text x="318" y="53" className="fill-attention-500 font-mono text-[8px] tracking-wide text-right stroke-none" textAnchor="end">REC</text>

          {/* Timecode */}
          <text x="192" y="53" className="fill-attention-500 font-mono text-[9px] tracking-widest" textAnchor="middle">00:04:12:15</text>

          {/* Battery */}
          <rect x="45" y="45" width="18" height="9" rx="1.5" strokeWidth="1" />
          <rect x="63" y="47" width="2" height="5" className="fill-attention-500 stroke-none" />
          <rect x="48" y="48" width="10" height="3" className="fill-attention-500 stroke-none" />
          <text x="70" y="52" className="fill-attention-500/60 font-mono text-[6px]">84%</text>
        </g>
      </svg>
    );
  }
  ...
  if (title === "Fitness") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-400 fill-none pointer-events-none transition-all duration-500">
        ...
        {/* Telemetry labels */}
        <text x="45" y="90" className="fill-attention-450/70 font-mono text-[9px] tracking-wider">HR: 145 BPM  |  ZONE 4</text>
        <text x="45" y="105" className="fill-slate-500 font-mono text-[7px]">PACE: 4&apos;45&quot; /KM  |  CAL: 650 KCAL</text>

        {/* Circular radial progress gauge */}
        <circle cx="192" cy="180" r="40" className="stroke-attention-500/10" strokeWidth="3" />
        <path d="M 192 140 A 40 40 0 1 1 152 180" className="stroke-attention-500" strokeWidth="3" strokeLinecap="round" filter="url(#amber-glow)" />
        <text x="192" y="183" className="fill-attention-400 font-mono text-[9px] font-bold" textAnchor="middle">84%</text>
        ...
        <g className="opacity-30">
          ...
          <circle cx="70" cy="420" r="2" className="fill-attention-400" />
          <circle cx="270" cy="410" r="2.5" className="fill-attention-500" />
        ...
        <path d="M 40 560 C 40 460, 344 460, 344 560" strokeWidth="1" stroke="rgba(212, 175, 55, 0.12)" />
        <path d="M 80 560 C 80 490, 304 490, 304 560" strokeWidth="1" stroke="rgba(212, 175, 55, 0.12)" />

        {/* Elevation Mountain Profile */}
        <g className="opacity-20 fill-attention-500/10">
          <path d="M 60 510 L 80 495 L 110 500 L 140 480 L 170 490 L 200 470 L 230 485 L 260 510 Z" strokeWidth="0.8" stroke="rgba(212, 175, 55, 0.3)" />
  ...
  if (title === "Learning") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-400 fill-none pointer-events-none transition-all duration-500">
        ...
        <g className="opacity-20 stroke-attention-500/30">
          ...
          <text x="90" y="202" className="fill-attention-400/40 font-mono text-[5px]" textAnchor="middle">AI_COPROC_CORE</text>
        </g>

        {/* Neural Network Nodes Layer web */}
        <g filter="url(#violet-glow)">
          <circle cx="100" cy="300" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="100" cy="360" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="100" cy="420" r="5" className="fill-attention-500" strokeWidth="1" />
          
          <circle cx="192" cy="250" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="192" cy="330" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="192" cy="410" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="192" cy="490" r="5" className="fill-attention-500" strokeWidth="1" />

          <circle cx="284" cy="330" r="5" className="fill-attention-500" strokeWidth="1" />
          <circle cx="284" cy="410" r="5" className="fill-attention-500" strokeWidth="1" />
        </g>

        {/* Connections */}
        <g className="stroke-attention-400/30">
        ...
        <g className="opacity-50">
          <line x1="220" y1="150" x2="300" y2="150" strokeWidth="0.6" stroke="rgba(212, 175, 55, 0.3)" />
          <line x1="260" y1="110" x2="260" y2="190" strokeWidth="0.6" stroke="rgba(212, 175, 55, 0.3)" strokeDasharray="1 1" />
          {/* S-curve */}
          <path d="M 220 180 Q 250 180 260 150 T 300 120" strokeWidth="1" strokeLinecap="round" />
          <text x="260" y="200" className="fill-attention-400/70 font-mono text-[5px]" textAnchor="middle">y = 1 / (1 + e^-x)</text>
        </g>

        {/* AI Processing Parameter HUD */}
        <text x="45" y="80" className="fill-attention-450/70 font-mono text-[9px] tracking-wider">MODEL: LLM_PROCESSOR_v4</text>
        ...
        <text x="70" y="240" className="fill-attention-500/20 font-mono text-[8px]">010110</text>
        <text x="310" y="270" className="fill-attention-500/20 font-mono text-[8px]">110101</text>
        <text x="60" y="520" className="fill-attention-500/20 font-mono text-[8px]">001101</text>
      </svg>
    );
  }
  ...
  if (title === "Motorcycling") {
    return (
      <svg viewBox="0 0 384 640" className="absolute inset-0 w-full h-full opacity-40 group-hover:opacity-85 stroke-attention-400 fill-none pointer-events-none transition-all duration-500">
        ...
        {/* Speedometer Arc */}
        <circle cx="192" cy="180" r="50" className="stroke-attention-500/10" strokeWidth="2" />
        <path d="M 152 210 A 50 50 0 1 1 232 210" className="stroke-attention-500" strokeWidth="2" strokeLinecap="round" filter="url(#orange-glow)" />
        <line x1="192" y1="180" x2="225" y2="150" strokeWidth="3" className="stroke-attention-500" strokeLinecap="round" filter="url(#orange-glow)" />
        <text x="192" y="195" className="fill-attention-450 font-mono text-[10px] font-bold" textAnchor="middle">95 KM/H</text>
        <text x="192" y="205" className="fill-slate-500 font-mono text-[5px]" textAnchor="middle">GEAR 6 // 5200 RPM</text>

        {/* Compass HUD circle */}
        <circle cx="192" cy="180" r="70" className="stroke-attention-500/5" strokeWidth="1" strokeDasharray="3 3" />
        <text x="192" y="102" className="fill-attention-500/40 font-mono text-[6px]" textAnchor="middle">N 0°</text>
        <text x="192" y="260" className="fill-attention-500/40 font-mono text-[6px]" textAnchor="middle">S 180°</text>

        {/* GPS coordinates & route telemetry */}
        <text x="45" y="90" className="fill-attention-450/70 font-mono text-[9px] tracking-wider">ROUTE: RANN OF KUTCH</text>
        ...
        <g className="opacity-30">
          ...
          <circle cx="140" cy="410" r="2" className="fill-attention-400" />
          <circle cx="220" cy="410" r="2" className="fill-attention-400" />
        ...
        <g className="opacity-20 stroke-attention-500/30">
          ...
          <text x="192" y="565" className="fill-attention-500/40 font-mono text-[5px]" textAnchor="middle">CHASSIS REF: RE_METEOR_650</text>
        </g>
      </svg>
    );
  }
        ...
        {activeDossier && (
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6 md:p-10">
            ...
            <motion.div
              ...
              className="relative w-full max-w-xl bg-neutral-950 border border-white/10 rounded-3xl p-6 md:p-8 overflow-hidden shadow-[0_0_50px_rgba(212, 175, 55, 0.02)] max-h-[85vh] overflow-y-auto"
            >
              ...
              <div className="absolute inset-0 bg-[linear-gradient(rgba(212, 175, 55, 0.01)_1px,transparent_1px),linear-gradient(90deg,rgba(212, 175, 55, 0.01)_1px,transparent_1px)] bg-[size:20px_20px] pointer-events-none opacity-40" />
