---
name: teamwork-compliance-workflow
description: >-
  Robust workflow to restore projects, analyze defects, validate scope, and
  delegate fixes to teamwork-preview, culminating in strict, evidence-based
