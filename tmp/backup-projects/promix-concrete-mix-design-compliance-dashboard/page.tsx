        ...
        >
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className="px-3 py-1.5 text-xs font-mono rounded-xl bg-neutral-950 border border-neutral-850 text-attention-200">Excel</span>
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            <h2 className="text-xl font-bold mb-4 inline-flex items-center gap-2 text-attention-400">
              ...
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />Mix Proportioning Engine</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />SCM Substitution Module</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />IS Compliance Auditor</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />Engineering Report Generator</li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            <h2 className="text-xl font-bold mb-4 inline-flex items-center gap-2 text-attention-400">
              ...
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>IS 10262:2019 Mix Proportioning</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>IS 456:2000 Durability Compliance</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Particle Packing Density Models</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Supplementary Cementitious Materials (SCM)</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Water-Cement Ratio Validation</span></li>
            </ul>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-sm font-mono text-neutral-400 uppercase tracking-wider border-b border-neutral-850 pb-2">Challenges Encountered</h3>
                                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[01]</span><p className="text-sm text-neutral-300 leading-relaxed">Designing a robust validation parser for SCM multi-blend replacements (GGBS, Fly Ash, OPC) where standard IS curves do not linearly interpolate.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[02]</span><p className="text-sm text-neutral-300 leading-relaxed">Resolving extreme aggregate moisture content fluctuations dynamically without causing division-by-zero errors in the dry volume equations.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[03]</span><p className="text-sm text-neutral-300 leading-relaxed">Configuring the compliance engine to prevent illegal mix configurations (e.g. w/c limits under extreme exposure conditions).</p></div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-mono text-neutral-400 uppercase tracking-wider border-b border-neutral-850 pb-2">Engineering Decisions & Lessons</h3>
                                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[01]</span><p className="text-sm text-neutral-300 leading-relaxed">Integrating physical standard specifications directly into code constraints prevents illegal trial mixes prior to laboratory trials.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[02]</span><p className="text-sm text-neutral-300 leading-relaxed">Partial SCM replacements dramatically affect early-age strength gain curves, which requires adjusting structural stripping timelines.</p></div>
