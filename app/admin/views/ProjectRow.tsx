...
export default function ProjectRow({ project, onEdit, onHistory }: ProjectRowProps) {
  ...
  if (isDraft) badgeColor = "border-slate-400/20 bg-slate-400/10 text-slate-400";
    ...
    <li className="flex flex-col gap-4 px-5 py-4 font-mono text-xs transition-colors hover:bg-white/[0.025] sm:flex-row sm:items-center sm:justify-between">
      ...
      <div className="flex gap-2 self-end sm:self-auto">
        <button
          ...
          className="flex items-center gap-1.5 rounded-lg border border-white/[0.08] bg-white/[0.035] px-3 py-1.5 text-slate-300 transition-all hover:bg-white/[0.07] hover:text-white"
        >
