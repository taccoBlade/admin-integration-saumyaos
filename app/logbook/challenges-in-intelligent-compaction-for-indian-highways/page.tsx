      ...
      <main className="relative max-w-3xl mx-auto px-6 py-12 md:py-24">
        ...
        >
          ...
          <div className="flex items-center gap-2 text-sm text-neutral-400">
            ...
            <Link href="/projects/automation-intelligent-machine-guided-construction" className="text-attention-400 hover:underline">
        ...
        >
          ...
          <p>
            When implementing computational solvers in this domain (specifically under the Intelligent Compaction framework), we hit significant non-linearities and boundary constraints. Traditional calculators simplify these, leading to unrealistic output values.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
                        <li className="text-neutral-300"><strong>Extended Kalman Filter (EKF)</strong>: Utilized to dynamically adjust parameters.</li>
            <li className="text-neutral-300"><strong>Fast Fourier Transform (FFT) Analysis</strong>: Utilized to dynamically adjust parameters.</li>
            <li className="text-neutral-300"><strong>RTK-GPS Navigation</strong>: Utilized to dynamically adjust parameters.</li>
