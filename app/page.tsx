  ...
  return (
    <main className="min-h-screen bg-[#08090b] text-slate-200 selection:bg-cyan-500/30 overflow-x-hidden relative">
      ...
      <section className="relative w-full max-w-7xl mx-auto px-5 py-24 sm:px-8 lg:px-12 border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <ScrollReveal variant="slideRight" className="lg:col-span-4">
            <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-cyan-400 mb-3">01 — Specialization</h2>
          ...
          <ScrollRevealStagger stagger={0.12} delay={0.1} className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <RevealItem key={idx}>
                <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:border-cyan-500/20 hover:-translate-y-1 transition-all flex flex-col justify-between h-full">
                  <div>
                    <item.icon className="w-5 h-5 text-cyan-400 mb-4" />
      ...
      <section className="relative w-full max-w-7xl mx-auto px-5 py-24 sm:px-8 lg:px-12 border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <ScrollReveal variant="slideRight" className="lg:col-span-4">
            <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-violet-400 mb-3">02 — Investigation</h2>
              ...
              <RevealItem>
                <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] h-full">
                  ...
                  <ul className="space-y-3 font-mono text-[11px] text-slate-300">
                    <li className="flex gap-2"><span className="text-violet-400">[01]</span><span>Geopolymer concrete mix proportioning and binder ratios optimization</span></li>
                    <li className="flex gap-2"><span className="text-violet-400">[02]</span><span>Edge image processing on microcontrollers for crack propagation metrics</span></li>
                    <li className="flex gap-2"><span className="text-violet-400">[03]</span><span>Extended Kalman Filter positioning algorithms for intelligent road rollers</span></li>
                  </ul>
                </div>
              </RevealItem>
              <RevealItem>
                <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] h-full">
                  ...
                  <ul className="space-y-3 font-mono text-[11px] text-slate-300">
                    <li className="flex gap-2"><span className="text-violet-400">[R1]</span><span>Terzaghi, K. Theoretical Soil Mechanics. Clay consolidation and structural settlement theories.</span></li>
                    <li className="flex gap-2"><span className="text-violet-400">[R2]</span><span>Neville, A. M. Properties of Concrete. Target strengths, w/c criteria, and hydration limits.</span></li>
                    <li className="flex gap-2"><span className="text-violet-400">[R3]</span><span>Kalman, R. E. State estimation and linear filtering principles in noisy sensor systems.</span></li>
                  </ul>
                </div>
              </RevealItem>
            </div>
      ...
      <section className="relative w-full max-w-7xl mx-auto px-5 py-24 sm:px-8 lg:px-12 border-t border-white/5">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          <ScrollReveal variant="slideRight" className="lg:col-span-4">
            <h2 className="text-sm font-semibold uppercase tracking-[0.3em] text-amber-400 mb-3">03 — Empirical Proof</h2>
          ...
          <ScrollRevealStagger stagger={0.12} delay={0.1} className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <RevealItem>
              <div className="p-5 rounded-2xl border border-white/5 bg-white/[0.01] space-y-4">
                ...
                <div className="border border-white/5 rounded-xl bg-black/40 p-4 font-mono text-[10px] text-slate-300 space-y-2">
                  <div className="text-amber-500 font-bold">ASTM D2216 Oven-Drying Calibration Curve:</div>
            ...
            <RevealItem>
              <div className="p-5 rounded-2xl border border-white/5 bg-white/[0.01] space-y-4">
                ...
                <div className="border border-white/5 rounded-xl bg-black/40 p-4 font-mono text-[10px] text-slate-300 space-y-2">
                  <div className="text-amber-500 font-bold">OpenCV Spatial Scale Validation:</div>
      ...
      <section className="relative w-full max-w-7xl mx-auto px-5 py-24 sm:px-8 lg:px-12 border-t border-white/5">
        <ScrollReveal variant="scaleIn">
          <div className="p-8 sm:p-12 rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.01] to-transparent backdrop-blur-md relative overflow-hidden group max-w-4xl mx-auto text-center">
            ...
            <span className="text-xs font-mono uppercase tracking-[0.3em] text-cyan-400 mb-3 block">04 — Beyond Infrastructure</span>
