    ...
    <main className="min-h-screen bg-[#08090b] text-slate-200 selection:bg-cyan-500/30 overflow-x-hidden relative">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-3 gap-5">
            {[
              ...
              <div key={idx} className="p-6 rounded-2xl border border-white/5 bg-white/[0.01] hover:border-cyan-500/20 transition-all flex flex-col justify-between">
                <div>
              ...
              <div className="p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                ...
                <ul className="space-y-3 font-mono text-[11px] text-slate-300">
                  <li className="flex gap-2">
                    ...
                    <span>Terzaghi, K. Theoretical Soil Mechanics. Clay consolidation and structural settlement theories.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-violet-400">[R2]</span>
                    <span>Neville, A. M. Properties of Concrete. Target strengths, w/c criteria, and hydration limits.</span>
                  </li>
                  <li className="flex gap-2">
                    <span className="text-violet-400">[R3]</span>
                    <span>Kalman, R. E. State estimation and linear filtering principles in noisy sensor systems.</span>
                  </li>
                </ul>
              </div>
            </div>
      ...
      <section className="relative w-full max-w-7xl mx-auto px-5 py-24 sm:px-8 lg:px-12 border-t border-white/5">
        <div className="p-8 sm:p-12 rounded-3xl border border-white/5 bg-gradient-to-br from-white/[0.01] to-transparent backdrop-blur-md relative overflow-hidden group max-w-4xl mx-auto text-center">
          ...
          <Link
            href="/personal"
            className="inline-flex items-center gap-2 px-6 py-3 rounded-full bg-white text-slate-900 text-xs font-semibold hover:bg-slate-100 transition-all active:scale-95 group/btn"
          >
