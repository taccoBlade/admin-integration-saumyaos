        ...
        >
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            ...
            <div className="flex flex-wrap gap-2">
                            <span className="px-3 py-1.5 text-xs font-mono rounded-xl bg-neutral-950 border border-neutral-850 text-attention-200">Arduino C++</span>
              ...
              <span className="px-3 py-1.5 text-xs font-mono rounded-xl bg-neutral-950 border border-neutral-850 text-attention-200">MQTT Protocol</span>
              <span className="px-3 py-1.5 text-xs font-mono rounded-xl bg-neutral-950 border border-neutral-850 text-attention-200">ESP32</span>
              <span className="px-3 py-1.5 text-xs font-mono rounded-xl bg-neutral-950 border border-neutral-850 text-attention-200">Chart.js</span>
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            <h2 className="text-xl font-bold mb-4 inline-flex items-center gap-2 text-attention-400">
              ...
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />ESP32-CAM Module</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />BX120-3AA Precision Strain Gauge</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />HX711 Amplifier Module</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />ADS1115 16-Bit ADC</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />DC-DC Buck Converter</li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            <h2 className="text-xl font-bold mb-4 inline-flex items-center gap-2 text-attention-400">
              ...
              Software Core
                        ...
                        <ul className="space-y-3 font-mono text-sm">
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />ESP32 ADC Reading Firmware</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />Flask Monitoring Backend</li>
              <li className="flex items-center gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500" />Chart.js Telemetry Grapher</li>
            </ul>
          </motion.div>
          ...
          <motion.div variants={itemVariants} className="p-6 md:p-8 rounded-3xl border border-neutral-800 bg-neutral-900/20 backdrop-blur-sm relative overflow-hidden">
            <h2 className="text-xl font-bold mb-4 inline-flex items-center gap-2 text-attention-400">
              ...
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Soil-Structure Interaction</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Settlement Consolidation</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Strain Calibration</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Wireless Data Acquisition</span></li>
              <li className="flex items-start gap-2 text-neutral-300"><span className="w-1.5 h-1.5 rounded-full bg-attention-500 mt-1.5 shrink-0" /><span>Geotechnical Edge Compute</span></li>
            </ul>
          </motion.div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h3 className="text-sm font-mono text-neutral-400 uppercase tracking-wider border-b border-neutral-850 pb-2">Challenges Encountered</h3>
                                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[01]</span><p className="text-sm text-neutral-300 leading-relaxed">Designing sensor layouts that survive soil compaction impacts up to 500 kPa without wire shear or damage.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[02]</span><p className="text-sm text-neutral-300 leading-relaxed">Calibrating strain gauge readings to isolate soil-induced deformation from sensor package thermal expansion.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[03]</span><p className="text-sm text-neutral-300 leading-relaxed">Configuring stable ESP32-CAM wireless data streams under deep soil burial conditions.</p></div>
              ...
              <div className="space-y-4">
                <h3 className="text-sm font-mono text-neutral-400 uppercase tracking-wider border-b border-neutral-850 pb-2">Engineering Decisions & Lessons</h3>
                                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[01]</span><p className="text-sm text-neutral-300 leading-relaxed">Waterproofing connection terminals with industrial silicone potting is mandatory for long-term geotechnical burial.</p></div>
                  <div className="flex gap-3"><span className="text-xs font-mono text-attention-500 shrink-0 mt-0.5">[02]</span><p className="text-sm text-neutral-300 leading-relaxed">High-precision ADC filters are required to eliminate high-frequency motor noise from heavy rollers on compaction sites.</p></div>
